...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto) values (2, 'Thai Delivery', 9.5, 1, utc_timestamp, utc_timestamp, true, true);
...
(1, 'João da Silva', 'joao.ger@algafood.com', '123123', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '123123', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '123123', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com', '123123', utc_timestamp),
...
values (1, '1d77ab05-0d61-45d0-a599-04fc1f44dfc7', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil', 'CRIADO', utc_timestamp, 298.90, 10, 308.90);
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
        endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, 'a1fcc298-6b7f-484c-aa00-ea42b6efd916', 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro', 'CRIADO', utc_timestamp, 79, 0, 79);
