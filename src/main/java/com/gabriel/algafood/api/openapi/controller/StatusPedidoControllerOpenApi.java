...
public interface StatusPedidoControllerOpenApi {
    ...
    void confirmarPedido(@ApiParam(value = "Código do pedido", required = true) String codigoPedido);
    ...
    void cancelarPedido(@ApiParam(value = "Código do pedido", required = true) String codigoPedido);
    ...
    void confirmarEntrega(@ApiParam(value = "Código do pedido", required = true) String codigoPedido);
}
