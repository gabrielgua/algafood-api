...
public interface FormaPagamentoControllerOpenApi {
    ...
    public ResponseEntity<FormaPagamentoModel> buscarPorId(@ApiParam(value = "ID da forma de pagamento", example = "1") Long id, ServletWebRequest request);

    @ApiOperation("Cadastra uma forma de pagamento")
    @ApiResponse(code = 201, message = "Forma de pagamento cadastrada")
    public FormaPagamentoModel salvar(@ApiParam(name = "Corpo", value = "Representação de uma nova forma de pagamento") FormaPagamentoRequest request);
    ...
    public FormaPagamentoModel editar(
    ...
    public void remover(@ApiParam(value = "ID de uma forma de pagamento") Long id);
}
