...
public interface GrupoPermissaoControllerOpenApi {
    ...
    public List<PermissaoModel> listarPermissoes(@ApiParam(value = "ID de um grupo", required = true) Long grupoId);
    ...
    public void desvincularPermissao(
            @ApiParam(value = "ID de um grupo", required = true) Long grupoId,
            @ApiParam(value = "ID de uma permissão", required = true) Long permissaoId);
}